# Voice, invariants and decisions (source of truth for copy revisions)

Facts live in `career.md` and `personal.md`. This file holds what a revision must not change,
the rules the copy is written under, and the decisions Shane has taken about it. A drafter
