...
export function decide(input) {
  ...
  if (/\bcodex\b[^\n]*\bimage_gen\b/.test(command) || /\bimage_gen\b[^\n]*\b(books|zion|wasatch|stansbury|redrock|pub|yale|utah)\b/.test(command)) {
    if (/\b(books|zion|wasatch|stansbury|redrock|pub|yale|utah)\b/.test(command) || /\bimages\//.test(command)) {
      return [
        `Blocked: image_gen against a photograph.`,
        `Everything in images/, and the books, zion, wasatch, stansbury, redrock, pub,`,
        `yale and utah stills derived from them in media/, are Shane's own photographs of real people in`,
